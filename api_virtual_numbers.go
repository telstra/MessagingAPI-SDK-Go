...
func (r ApiGetNumbersRequest) GetNumbers() (*GetNumbers200Response, *http.Response, error) {
	return r.Execute()
}
...
func (r ApiGetRecipientOptoutsRequest) GetRecipientOptouts() (*GetRecipientOptouts200Response, *http.Response, error) {
	return r.Execute()
}
